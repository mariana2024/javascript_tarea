...
if (str1.lenght== str2.lenght){
 ...
 function esPositivo(numero) {
  ...
  const devolverPrimerElemento = (array) => {
    ...
    // Tu código:
    let array = ["Vogue","Trendy","RubyRose","Vitu"];
    return (array[0]);
  }
  ...
  const sumarLikesDeUsuario = usuario => {
    ...
    for(var e = 0; e< usuario.posts.length; e++){
      sumarloslikes = sumarloslikes + usuario.posts[e].likes;
    }
    return sumarloslikes;
  }
...
const copiarEach = (array, cb) =>{
  ...
  az = array.filter(function(array){
    return az = array.charAt(0) === 'a';})
  return az;
